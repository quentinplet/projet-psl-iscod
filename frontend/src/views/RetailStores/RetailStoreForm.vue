    ...
    <div class="mx-auto w-full max-w-7xl">
        <div class="flex items-center justify-between mb-5">
            <h1 v-if="!loading" class="text-3xl font-semibold">
                {{
                    retailStore.id
                        ? `Mettre à jour un lieu de vente: "${retailStore.name}"`
                    ...
                    <div>
                        ...
                        <fieldset class="fieldset w-fit">
                            ...
                            <CustomTextArea
                                ...
                                id="description"
                                name="description"
                                v-model="retailStore.description"
                    ...
                    <div>
                        ...
                        <fieldset class="fieldset w-fit">
                            <CustomInputText
                                ...
                                name="street"
                                label="Numéro et rue"
                                v-model="retailStore.address.street"
                            ...
                            <CustomInputText
                                ...
                                name="city"
                                label="Ville"
                                v-model="retailStore.address.city"
                            ...
                            <CustomInputText
                                ...
                                name="postal_code"
                                label="Code postal"
                                v-model="retailStore.address.postal_code"
                            ...
                            <CustomTextArea
                                ...
                                v-model="retailStore.address.additional_info"
                                :errors="
...
onMounted(async () => {
    if (route.params.id) {
        ...
        const retailStoreData = await retailStoresStore.getOne(id);
        retailStore.value = retailStoreData.data;
    }
...
async function onSubmit($event, close = false) {
    ...
    if (retailStore.value.id) {
        await retailStoresStore.update(retailStore.value.id, retailStore.value);
    } else {
        const response = await retailStoresStore.create(retailStore.value);
        retailStore.value.id = response.data.id;
    }

    if (close) {
        router.push({ name: "app.retailStores" });
    } else {
        router.push({
            name: "app.retailStores.edit",
            params: { id: retailStore.value.id },
        });
    }
}
</script>
